#-------------------------------------------------------------------------------
# Name:        DEV_TRACKER_Process_Existing_DU_Map_11.py
# Purpose:
"""
...
def main():
    ...
    # Name of this script
    name_of_script = 'DEV_TRACKER_Process_Existing_DU_Map_11.py'


    # Set name to give outputs for this script
    shorthand_name    = 'Existing_DU_Map_11'
    ...
    try:
        out_name   = '{}_Pts'.format(shorthand_name)
