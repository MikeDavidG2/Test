...
cmroads     = warehouse + "SDE.SANGIS.ROAD_SEGMENTS" #"SDE.SANGIS.ROADS_CNTY_MAINTAINED"
...
datestart   = "2017-01-01"  ## Date should be in format yyyy-mm-dd"
dateend     = "2017-01-31"  ## Date should be in format yyyy-mm-dd"
